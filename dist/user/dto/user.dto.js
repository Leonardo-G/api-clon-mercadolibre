...
__decorate([
    ...
    (0, class_validator_1.IsIn)(['user', 'official-store']),
    __metadata("design:type", String)
], UserRegisterDTO.prototype, "typeUser", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UserRegisterDTO.prototype, "imgUrl", void 0);
exports.UserRegisterDTO = UserRegisterDTO;
class UserLoginDTO extends (0, mapped_types_1.PickType)(UserRegisterDTO, [
    'email',
    'password',
]) {
}
